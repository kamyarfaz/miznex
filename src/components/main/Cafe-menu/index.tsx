          ...
          <div className="max-w-md mx-auto">
            <div className="flex items-center justify-end mb-6">
              <div className="flex gap-2">
                <ShoppingBag
                  size={20}
                  className="size-12 p-3 backdrop-blur rounded-full"
                />
                <User
                  size={20}
                  className="size-12 p-3 backdrop-blur rounded-full"
            ...
            <h1 className="text-2xl font-bold text-center mb-4">
              به کافه {params.cafe} خوش آمدید.
            </h1>

            {/* Search Bar */}
            <div className="flex items-center bg-white/10 border border-white/30 backdrop-blur rounded-lg px-4 py-3">
              <input
                type="text"
        ...
        <Modal
          ...
          modalContent={
            <div className="overflow-auto h-100 p-4">
              ...
              {/* Size Selection */}
              <div className="border-b mb-3 pb-6">
                <h3 className="font-bold text-right mb-3">
                  سایز لیوان را انتخاب کنید
                </h3>
                <div className="flex gap-3 flex-row-reverse">
              ...
              <div className="mb-6">
                ...
                <div className="space-y-2">
                  {["سیروپ کاراملی", "سیروپ وانیلی", "سیروپ فندقی"].map(
                    (syrup) => (
                      <label
                        key={syrup}
              ...
              {/* Add to Cart Button */}
              <Link href="/cart">
                <button className="w-full cursor-pointer bg-red-500 hover:bg-red-600 text-white font-bold py-3 px-4 rounded-xl transition">
                  افزودن به سبد خرید
                </button>
              </Link>
            </div>
